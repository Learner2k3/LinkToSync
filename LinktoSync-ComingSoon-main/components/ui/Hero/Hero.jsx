...
const Hero = () => (
    <section>
        <div className="custom-screen py-28 mt-[-50px]">
            ...
            >
                <div>
                    <div className="space-y-5 max-w-6xl mx-auto text-center">
                        ...
                        >
                           <span className="leading-normal"><span className="text-[#16f2b3] ">LinktoSync<span className=" text-[#e15555] ">.com</span> </span>is  a service that allows user to connect and post on their social media accounts from a Single Platform.</span>
                        </h1>
