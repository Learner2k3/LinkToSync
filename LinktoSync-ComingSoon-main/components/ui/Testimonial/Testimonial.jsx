        ...
        <SectionWrapper>
            <div id="testimonials" className="custom-screen text-gray-300 mt-[-240px] ">
                ...
                <GradientWrapper wrapperClassName="max-w-sm h-40 top-12 inset-x-0" className="mt-12">
                    ...
                    >
                        <ul className="grid gap-8 duration-1000 delay-300 ease-in-out sm:grid-cols-2 lg:grid-cols-3">
                            {
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-x-4">
                                            ...
                                            <div className="inline-block">
                                                    <span className="block text-gray-50 font-bold text-[40px] text-center">{item.name}</span>
